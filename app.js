...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function drawCurveCanvas() {
        ...
        const curUnit = curWDays > 1.0 ? 'jours ressentis' : 'jour ressenti';
        ...
        if (hoveredAge !== null && hoveredAge >= 1 && hoveredAge <= maxAge) {
            ...
            if (canvasTooltip) {
                ...
                if (ttWeek) {
                    ...
                    const unit = wDays > 1.0 ? 'jours ressentis' : 'jour ressenti';
    ...
    function renderLifeGrid() {
        ...
        for (let year = 1; year <= maxAge; year++) {
            ...
            const gridUnit = gridDays > 1.0 ? 'jours ressentis' : 'jour ressenti';
